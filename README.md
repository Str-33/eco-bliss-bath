...
```bash
git clone https://github.com/Str-33/eco-bliss-bath.git
cd eco-bliss-bath
```
...
```bash
cd Eco-Bliss-Bath-V2-main/frontend
npm install
```
...
Le rapport est disponible dans `Eco-Bliss-Bath-V2-main/frontend/cypress/reports/report.html`.
